    ...
    <div className="right-sidebar">
      ...
      <div className="section">
        <div className="section-header">
          ...
          <button className="btn btn-sm btn-ghost" onClick={onToggleNotifications}>
            {notificationsOpen ? "Hide" : "Show"} ({notificationUnreadCount})
          </button>
        </div>
        {notificationsOpen && (
      ...
      <div className="section">
        <div className="section-header">
          <span className="section-title">Tool Metrics</span>
        </div>
        <div className="section-content">
          <div className="list" style={{ maxHeight: "150px", overflowY: "auto" }}>
            {toolMetrics.map((t) => (
